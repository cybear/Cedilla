  ...
  function(ç){
    ...
    return{
      blur:function(px, px_up, px_left, px_down, px_right){
        return [
          (px[0]+px_up[0]+px_down[0]+px_left[0]+px_right[0])/5,
          (px[1]+px_up[1]+px_down[1]+px_left[1]+px_right[1])/5,
          (px[2]+px_up[2]+px_down[2]+px_left[2]+px_right[2])/5,
          (px[3]+px_up[3]+px_down[3]+px_left[3]+px_right[3])/5
        ];
      },
